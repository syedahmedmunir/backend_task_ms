...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Array Extracted From Data GIven In DB SQL For Countries
        ...
        foreach($country_array as $country){
            ...
            $country_nicename       = $country[2] ?? '-';
            $country_iso3           = $country[3] ?? '-';
            $country_numcode        = $country[4] ?? 0;
            $country_phonecode      = $country[5] ?? null;
            

            $country_create = Country::updateOrCreate(['name'=>$country_name],
            [
